...
# ]
#novel class json
# COCO_BASE_CatName = ["person","tl_green","tl_red","tl_none","train"]
# COCO_NOVEL_CatName = ["traffic_sign","box"]
#base_noval_json
COCO_BASE_CatName = ["traffic_sign","box"]
COCO_NOVEL_CatName = ["person","tl_green","tl_red","tl_none","train"]
